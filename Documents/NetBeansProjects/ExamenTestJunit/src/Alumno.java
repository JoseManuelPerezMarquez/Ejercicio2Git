...
public class Alumno {
    ...
    public Alumno(String string, String string0, int i, String string1, int i0, int i1) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Alumno(double notaPractica1, double notaPractica2, double notaPractica3) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
